...
extern UDPLIB_API IReceiveManager *createAeronReceiveManager(unsigned myNodeIndex);
extern UDPLIB_API ISendManager *createAeronSendManager(unsigned myNodeIndex);
