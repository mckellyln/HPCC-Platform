...
private:
    ...
    virtual size32_t write2(void const* buf, size32_t size) override { UNIMPLEMENTED; }
    virtual size32_t writetms(void const* buf, size32_t size, unsigned timeoutms=WAIT_FOREVER) override { UNIMPLEMENTED; }
    virtual size32_t writetms2(void const* buf, size32_t size, unsigned timeoutms=WAIT_FOREVER) override { UNIMPLEMENTED; }
