...
bool initClientProcess(IGroup *servergrp, DaliClientRole role, unsigned mpport, const char *clientVersion, const char *minServerVersion, unsigned timeout, bool _listen)
{
    assertex(servergrp);
    daliClientIsActive = true;
    startMPServer(role, mpport, false, _listen);
